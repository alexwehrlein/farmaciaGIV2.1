...
public class Controlador_Proveedores {
    ...
    public Controlador_Proveedores(Pantalla_principal pantalla_principal , int idEm , int idSucursal) {
        ...
        pantalla_proveedores.btnCancelarAgregar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                new Controlador_Proveedores(pantalla_principal , idEm , idSucursal);
                pantalla_proveedores.dispose();
