...
public class Controlador_Empleados {
    ...
    public Controlador_Empleados(Pantalla_principal pantalla_principal , int idEm , int idSucursal) {
        ...
        pp.btnAction.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                String puesto = pp.comboPuesto.getSelectedItem().toString();
                ...
                if (idEmpleado == 0) {// si es 0 indica que se regristrara un nuevo usuario
                    empleados = new Empleados(nombre, telefono, email, turno, "SI", puesto ,idSucursal);
                    ...
                    empleados = new Empleados(idEmpleado, nombre, telefono, email , turno, status, puesto , idSucursal );
